...
CREATE TABLE IF NOT EXISTS settings (
  ...
  address TEXT DEFAULT 'Villeneuve d''Ascq & Métropole Lilloise (59)',
  hours TEXT DEFAULT 'Lun – Ven : 8h – 18h\nSam : sur rendez-vous',
  site_description TEXT DEFAULT 'CL Paysage, artisan paysagiste et jardinier à Villeneuve d''Ascq (59650) et métropole lilloise. Conception, aménagement extérieur et entretien de jardin complet.',
  hero_bg_image TEXT DEFAULT '/images/hero.jpg',
  hero_tagline TEXT DEFAULT 'Artisan paysagiste · Villeneuve d''Ascq & Métropole Lilloise',
  hero_title_line1 TEXT DEFAULT 'Paysagiste & Jardinage',
  hero_title_line2 TEXT DEFAULT 'à Villeneuve d''Ascq',
  hero_description TEXT DEFAULT 'Conception sur-mesure, aménagement paysager et entretien de jardin (tonte, taille de haies, massifs, terrasses) à Villeneuve d''Ascq, Hem, Croix, Marcq-en-Barœul et aux alentours.',
  hero_button_text TEXT DEFAULT 'Découvrir nos réalisations',
  brand_name TEXT DEFAULT 'CL',
  brand_accent TEXT DEFAULT 'Paysage',
  brand_sub TEXT DEFAULT 'Paysagiste & Jardinier · Villeneuve d''Ascq',
...
VALUES (
  ...
  'Villeneuve d''Ascq & Métropole Lilloise (59)',
  E'Lun – Ven : 8h – 18h\nSam : sur rendez-vous',
  'CL Paysage, artisan paysagiste et jardinier à Villeneuve d''Ascq (59650) et métropole lilloise. Conception, aménagement extérieur et entretien de jardin complet.',
  COALESCE((SELECT (data->'hero'->>'bgImage') FROM settings WHERE id = 1), '/images/hero.jpg'),
  'Artisan paysagiste · Villeneuve d''Ascq & Métropole Lilloise',
  'Paysagiste & Jardinage',
  'à Villeneuve d''Ascq',
  'Conception sur-mesure, aménagement paysager et entretien de jardin (tonte, taille de haies, massifs, terrasses) à Villeneuve d''Ascq, Hem, Croix, Marcq-en-Barœul et aux alentours.',
  'Découvrir nos réalisations',
  'CL',
  'Paysage',
  'Paysagiste & Jardinier · Villeneuve d''Ascq',
  '/images/logo.png',
